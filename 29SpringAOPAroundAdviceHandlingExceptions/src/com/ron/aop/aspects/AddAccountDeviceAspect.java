...
public class AddAccountDeviceAspect {
	...
	public Object aroundAdviceGetFortune(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
		...
		try {
			...
			// log the exception
			Logger logger = Logger.getLogger(AddAccountDeviceAspect.class.getName());
			logger.warning(e.getMessage());
			// give user a custom message
			result = "aop tripwire exception handled successfully...";

			// We can also re-throw an exception using throw e, to the main application
			// throw e;
		}
