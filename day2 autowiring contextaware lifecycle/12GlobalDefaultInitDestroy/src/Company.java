...
public class Company {
	...
	public String toString() {
		return "Company [companyName=" + compName + ", companyLocation=" + compLocation + ", companyInfo=" + compInfo
				+ "]";
	}

	public void myInit() {
		System.out.println("Spring Company Bean is initialized...");
	}

	public void cleanUp() {
		System.out.println("Spring Company Bean is Cleaned up...");
	}
